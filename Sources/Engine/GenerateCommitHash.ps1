# NOTE: Set this line to $false to temporarily disable generation
# of new values to prevent all projects from rebuilding every time
...
if ($determineValues) {
  ...
  # Bail if the file has been generated already
  if (Test-Path -Path $outputFile) {
    exit 0
  }

  # Otherwise generate one with dummy values
  $branchName = "main"
  $commitHash = "0000000000000000000000000000000000000000"
