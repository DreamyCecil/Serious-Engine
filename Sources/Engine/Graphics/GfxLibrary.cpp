...
INDEX shd_bShowFlats  = FALSE;  // colorize flat shadows
...
INDEX d3d_bFastUpload = TRUE;            // use internal format conversion routines
...
INDEX wed_bUseGenericTextureReplacement = FALSE; // [Cecil] Defined here
